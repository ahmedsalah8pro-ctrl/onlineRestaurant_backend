...
export class UiTextService {
  ...
  private readonly dictionary: Record<string, Record<Locale, string>> = {
    ...
    'share.short': { ar: 'شارك', en: 'Share' },
    'share.preview': { ar: 'معاينة الرابط', en: 'Share Preview' },
    'share.ready': { ar: 'الرابط جاهز للنشر والإعلانات والمشاركة.', en: 'Your link is ready for ads, campaigns, and social sharing.' },
    'share.tryAgain': { ar: 'إعادة المحاولة', en: 'Try Again' },
    'share.error': { ar: 'تعذر إنشاء رابط المشاركة الآن.', en: 'Unable to create a share link right now.' },
    'share.direct': { ar: 'فتح الرابط', en: 'Open Link' },
    'share.channels': { ar: 'قنوات المشاركة', en: 'Share Channels' },
    'share.campaign': { ar: 'جاهز للواتساب وفيسبوك والإعلانات', en: 'Ready for WhatsApp, Facebook, and campaigns' },
    ...
    'product.mediaGallery': { ar: 'معرض الوسائط', en: 'Media Gallery' },
    'product.mediaGalleryCopy': { ar: 'استعرض الصور والفيديوهات المرتبطة بالمنتج مع تنقل سريع وتكبير عند الحاجة.', en: 'Browse product images and videos with fast switching and zoom when needed.' },
    'product.viewMedia': { ar: 'عرض مكبر', en: 'Open Viewer' },
    'product.prevMedia': { ar: 'السابق', en: 'Previous media' },
    'product.nextMedia': { ar: 'التالي', en: 'Next media' },
    'product.zoomIn': { ar: 'تكبير', en: 'Zoom in' },
    'product.zoomOut': { ar: 'تصغير', en: 'Zoom out' },
    'product.resetZoom': { ar: 'إعادة الضبط', en: 'Reset zoom' },
    'product.featuredMedia': { ar: 'الوسيط الرئيسي', en: 'Featured media' },
    'product.galleryImage': { ar: 'صورة', en: 'Image' },
    'product.galleryVideo': { ar: 'فيديو', en: 'Video' },
    'product.galleryYouTube': { ar: 'يوتيوب', en: 'YouTube' },
    'product.quickPreview': { ar: 'معاينة سريعة', en: 'Quick Preview' },
    ...
    'admin.mediaStudio.eyebrow': { ar: 'استوديو الوسائط', en: 'Media Studio' },
    'admin.mediaStudio.title': { ar: 'جهّز وسائط المنتج بالشكل الذي يراه العميل', en: 'Prepare the product visuals customers will actually see' },
    'admin.mediaStudio.subtitle': { ar: 'أدر الصورة الرئيسية ومعرض الصور والفيديو وروابط يوتيوب من مساحة واحدة مرتبة.', en: 'Manage the featured asset, gallery images, videos, and YouTube embeds from one clean workspace.' },
    'admin.mediaStudio.featuredCount': { ar: 'وسيط رئيسي', en: 'Featured asset' },
    'admin.mediaStudio.galleryCount': { ar: 'عنصر معرض', en: 'gallery items' },
    'admin.mediaStudio.featuredPreview': { ar: 'معاينة الوسيط الرئيسي', en: 'Featured media preview' },
    'admin.mediaStudio.featuredPreviewCopy': { ar: 'ارفع الصورة الرئيسية أو الصق رابط الوسيط المباشر.', en: 'Upload a primary image or paste a direct media URL.' },
    'admin.mediaStudio.featuredBadge': { ar: 'الرئيسي', en: 'Featured' },
    'admin.mediaStudio.priority': { ar: 'أولوية العرض', en: 'Storefront Priority' },
    'admin.mediaStudio.priorityTitle': { ar: 'الوسيط الأساسي لبطاقات المنيو ومعاينات المشاركة', en: 'Primary visual for cards and social previews' },
    'admin.mediaStudio.priorityCopy': { ar: 'هذا الوسيط يظهر أولاً في بطاقات المنيو ومعاينة المنتج ومعظم روابط المشاركة.', en: 'This asset is used first in menu cards, product previews, and most shared links.' },
    'admin.mediaStudio.ready': { ar: 'جاهز للنشر', en: 'Ready to publish' },
    'admin.mediaStudio.needsSource': { ar: 'يحتاج إلى مصدر', en: 'Needs a source' },
    'admin.mediaStudio.featuredAsset': { ar: 'الوسيط الرئيسي', en: 'Featured Asset' },
    'admin.mediaStudio.featuredAssetCopy': { ar: 'حدّد الصورة أو الفيديو الذي يمثّل المنتج في كل أماكن العرض.', en: 'Set the hero image or video that represents the product everywhere.' },
    'admin.mediaStudio.primarySource': { ar: 'مصدر الوسيط الرئيسي', en: 'Primary media source' },
    'admin.mediaStudio.sourcePlaceholder': { ar: 'مثال: /media/catalog/pizza.jpg أو https://...', en: 'e.g. /media/catalog/pizza.jpg or https://...' },
    'admin.mediaStudio.uploadFeatured': { ar: 'رفع الصورة الرئيسية', en: 'Upload featured image' },
    'admin.mediaStudio.addGalleryItem': { ar: 'إضافة عنصر للمعرض', en: 'Add gallery item' },
    'admin.mediaStudio.clearFeatured': { ar: 'مسح الرئيسي', en: 'Clear featured' },
    'admin.mediaStudio.galleryBadge': { ar: 'المعرض', en: 'Gallery' },
    'admin.mediaStudio.galleryTitle': { ar: 'وسائط المنتج الإضافية', en: 'Supporting Media Assets' },
    'admin.mediaStudio.galleryCopy': { ar: 'أضف صورًا وفيديوهات وروابط يوتيوب لصفحة تفاصيل المنتج.', en: 'Add extra photos, videos, or YouTube embeds for the product details page.' },
    'admin.mediaStudio.uploadGallery': { ar: 'رفع إلى المعرض', en: 'Upload to gallery' },
    'admin.mediaStudio.manualEntry': { ar: 'إدخال يدوي', en: 'Manual entry' },
    'admin.mediaStudio.mediaType': { ar: 'نوع الوسيط', en: 'Media type' },
    'admin.mediaStudio.source': { ar: 'رابط / مسار المصدر', en: 'Source URL / Path' },
    'admin.mediaStudio.primaryMedia': { ar: 'الوسيط الأساسي', en: 'Primary media' },
    'admin.mediaStudio.makePrimary': { ar: 'اجعله أساسيًا', en: 'Make primary' },
    'admin.mediaStudio.noGallery': { ar: 'لا توجد عناصر في المعرض بعد', en: 'No gallery assets yet' },
    'admin.mediaStudio.noGalleryCopy': { ar: 'ابدأ ببعض الصور أو الفيديوهات الإضافية ليبدو المنتج أكثر اكتمالًا وثقة.', en: 'Start with a few supporting photos so the product page feels richer and more trustworthy.' },
    'admin.mediaStudio.addFirstGalleryItem': { ar: 'أضف أول عنصر للمعرض', en: 'Add first gallery item' },
